...
## Содержание
1. [Отправка метрик через терминал](#1-отправка-метрик-через-терминал)  
2. [Настройка источника данных в Grafana](#2-настройка-источника-данных-в-grafana)  
3. [Создание графика для метрики](#3-создание-графика-для-метрики)  
4. [Просмотр изменений на графике](#4-просмотр-изменений-на-графике)  
5. [Итог](#5-итог)  
...
### 4. Просмотр изменений на графике
После отправки новых значений я увидел, как график начал обновляться. Но заметил, что между точками иногда появляются разрывы. Чтобы это исправить, я сделал следующее (рис. 2):
